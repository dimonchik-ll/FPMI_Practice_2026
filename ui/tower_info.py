...
_TOWER_HINTS: dict[TowerKind, str] = {
    ...
    TowerKind.MAGE_1: "Маг запускает огненный шар и наносит урон по области.",
    TowerKind.MAGE_2: "Более мощный огненный шар с увеличенным радиусом.",
    TowerKind.MAGE_3: "Хорошо работает против плотных групп врагов.",
    TowerKind.MAGE_4: "Усиленная магическая башня для середины игры.",
    TowerKind.MAGE_5: "Большой splash-урон по группам на дороге.",
    TowerKind.MAGE_6: "Высокая дальность и стабильный урон по области.",
    TowerKind.MAGE_7: "Почти максимальная магическая башня против волн 5+.",
    TowerKind.MAGE_8: "Максимальный маг: огромный огненный взрыв по области.",
}
